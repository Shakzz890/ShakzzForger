    ...
    n = {
        ...
        const u = {
          ...
          p = function (e, t) {
            ...
            return (
              ...
              (v.bitrateSelection = (0, s.qh)(O) ? O : u.bitrateSelection),
      ...
      623: (e, t, n) => {
        ...
        const T = function (e) {
          ...
          F = (e, t) => {
            ...
            return (0, E.Z)() ? I(e, t).then(n).catch(n) : n();
          },
          B = function (e) {
                ...
                (i.addToPlayer = function (e = !1) {
                  ...
                  if (t)
                    return (
                      ...
                      t.appendChild(n),
                      e
                        ? this.trigger("pluginInitialized", o)
                        : setTimeout(
                            () => this.trigger("pluginInitialized", o),
                            0
                          ),
      ...
      1241: (e, t, n) => {
        ...
        const c = new (class {
          ...
          d = async (e, t, n) => {
            ...
            return (
              r === e && (s = e),
              c.setupPlugin(s).then((e) => (0, i.MK)(e, t, n))
            );
          };
        function p(e, t) {
      ...
      5882: (e, t, n) => {
        ...
        const b = (e, t, n) => {
          ...
          x = (e, t) => {
            if (
              (v || (v = new I(document).on("interaction")),
          ...
          A = (e) => {
            ...
            x(e, p),
              S(
                ...
                p,
                (i) => {
                  if (((0, a.IV)(t, "jw-tab-focus"), O(i))) return;
      ...
      6577: (e, t, n) => {
        ...
        const k = [["vastxml", "adtag", "schedules"]],
          ...
          C = (e, t) => {
            ...
            if (-1 === r.indexOf(t))
              throw new Error(
                `destroyDynamicPlugin must be called with plugins with one of the following plugins: ${r.toString()}`
              );
            if (!n) return;
            if (
              (n.resize && e.off("resize", n.resizeHandler),
              delete e.plugins[t],
              n.destroy)
            )
              try {
          ...
          P = (e, t, n, r) => {
            ...
            if (-1 === o.indexOf(i))
              throw new Error(
                `setupDynamicPlugin must be called with plugins with one of the following plugins: ${o.toString()}`
              );
            C(e, i);
            const a = ((e, t, n) => {
        ...
        function A(e) {
          ...
          r.tick("init"),
            ...
            Object.defineProperties(this, {
              ...
              version: { enumerable: !0, get: () => h.i },
              Events: { enumerable: !0, get: () => b.ZP },
              utils: { enumerable: !0, get: () => O.Z },
              _: { enumerable: !0, get: () => x.ZP },
            }),
            Object.assign(this, {
              _events: {},
              setup(t) {
              ...
              getPlaylistItem(e) {
                if (!O.Z.exists(e)) return o.get("playlistItem");
        ...
        Object.assign(A.prototype, {
          ...
          trigger(e, t) {
            return (
              ((t = x.ZP.isObject(t) ? Object.assign({}, t) : {}).type = e),
        ...
        const Z = (e) => {
          ...
          _ = function (e) {
            ...
            if (
              (e
                ? "string" == typeof e
                  ? ((t = Z(e)), t || (n = document.getElementById(e)))
                  : "number" == typeof e
                  ? (t = s.Z[e])
                  : e.nodeType &&
                    ((n = e),
                    (t = Z(n.id || n.getAttribute("data-jwplayer-id"))))
                : (t = s.Z[0]),
              t)
            )
              return t;
        ...
        const V = /^(?:on(?:ce)?|off|trigger)$/,
          ...
          J = function (e) {
            const t = {};
            X(this, e, e, t), X(this, e, A.prototype, t);
          },
          Y = window;
        Object.assign(I, z);
        const ee = function (e) {
      ...
      3487: (e, t, n) => {
        "use strict";
        n.d(t, { MK: () => r.MK, Nq: () => r.Nq, bX: () => i, sb: () => o });
        n(1569);
        var r = n(7164);
        const i = function (e) {
            let t = (0, r.bX)(e);
          ...
          o = (e) => {
            ...
            const n = {
              ...
              interactive: "/player/jw8/interactive.js",
            }[e];
            return n ? t + n : "";
          };
      },
      ...
      386: (e, t, n) => {
        ...
        function f(e) {
          const t = {
            ...
            drm: [r, i, o, s, a, l, u, d, p, c],
            ads: [r, i, o, s, a, l, u, d, p, c],
            jwpsrv: [i],
            discovery: [r, i, o, s, a, l, u, d, p, c],
          };
          return function (n) {
